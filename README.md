...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/construct-typing-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14335&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/construct-typing-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `construct-typing` can be installed with:

```
conda install construct-typing
```

It is possible to list all of the versions of `construct-typing` available on your platform with:
